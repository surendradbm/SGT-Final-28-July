<x-default-layout>
    ...
    <div class="py-3">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="{{ route('superadmin.guard.edit') }}">Aman Kumar</a></li>
        </ul>
    </div>
    {{-- Breadcrumbs (End) --}}
            ...
            <div class="card-body py-5">
                <div class="row mb-5">
                    <div class="col-lg-12 col-md-4 col-12">
                        <h4 class="text-dark fw-bold">Below are the Account Details of Aman Kumar</h4>
                        <div class="float-end">
                ...
                <div class="row mb-5">
                    <div class="col-md-12">
                        ...
                        <div class="image-input image-input-empty" data-kt-image-input="true">
                            ...
                            <div class="image-input-wrapper rounded-circle w-130px h-130px" style="background-image: url({{ asset('/assets/media/avatars/300-1.jpg') }})"></div>
                            <!--begin::Edit button-->
                            <label class="btn btn-primary btn-sm" data-kt-image-input-action="change" data-bs-dismiss="click"> Update Photo
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid" name="name" id="name"
                                placeholder="Enter Guard Name" value="Aman Kumar" required>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid" name="position" id="position"
                                placeholder="Enter Position" value="Supervisor" required>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="form-group">
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid" name="birth_date" id="date"
                                placeholder="Enter Date Of Birth" value="22-07-2023" required>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid" name="phone" id="phone"
                                placeholder="Enter Mobile Number" value="+919345746464" required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <select class="form-select form-select-solid" id="state" name="state"
                                ...
                                <option selected value="">Utter Pradesh</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <select class="form-select form-select-solid" id="city" name="city"
                                ...
                                <option selected value="Lucknow">Lucknow</option>
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid" name="street" id="street"
                                placeholder="Enter Street" value="Ashiana" required>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-solid" name="zip_code" id="zip_code"
                                placeholder="Enter Zip Code" value="226010" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control form-control-solid" name="email" id="email"
                                placeholder="Enter Email Address" value="abc@gmail.com" required>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="form-group">
                            ...
                            <div class="password-input">
                                <input type="password" class="form-control form-control-solid" id="password" name="password"
                                    placeholder="Password" value="abc@123" >
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-4 col-12">
                        ...
                        <div class="image-input image-input-empty" data-kt-image-input="true">
                            <!--begin::Image preview wrapper-->
                            <div class="image-input-wrapper w-300px h-150px" style="background-image: url({{ asset('/assets/media/avatars/idcard.png') }})"></div>
                            <!--begin::Edit button-->
                            <label class="btn btn-primary btn-sm inverse" data-kt-image-input-action="change" data-bs-dismiss="click"> Update ID Card
