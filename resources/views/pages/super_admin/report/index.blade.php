...
<style>
                ...
                <div class="d-flex flex-stack flex-wrap">
                    ...
                    <div class="">
                        <button class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#general-report-modal">General Report</button>
                        <button class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#maintenance-report-modal">Maintenance Report</button>
                        <button class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#emergency-report-modal">Emergency Report</button>
                        <button class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#parking-report-modal">Parking Report</button>
                    </div>
                    <div class="">
                        {{-- Filter button Start --}}
    ...
    <div class="modal fade" id="general-report-modal" tabindex="-1" aria-labelledby="general-report-modal"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-6">
                                <img src="{{ asset('assets/images/reports/image-sample-2.png') }}" alt="image-sample"
                                    class="img-fluid rounded">
                            </div>
                            <div class="col-lg-3 col-6">
                                <img src="{{ asset('assets/images/reports/image-sample-3.png') }}" alt="image-sample"
                                    class="img-fluid rounded">
                            </div>
                            <div class="col-lg-3 col-6">
                                <img src="{{ asset('assets/images/reports/image-sample-4.png') }}" alt="image-sample"
                                    class="img-fluid rounded">
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="maintenance-report-modal" tabindex="-1" aria-labelledby="maintenance-report-modal"
        aria-hidden="true">
        <div class="modal-dialog rounded">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="parking-report-modal" tabindex="-1" aria-labelledby="parking-report-modal"
        aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="form-group mb-5">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-6">
                                        <img src="{{ asset('assets/images/reports/image-sample-1.png') }}"
                                            alt="image-sample" class="img-fluid rounded">
                                    </div>
                                    <div class="col-lg-3 col-6">
                                        <img src="{{ asset('assets/images/reports/image-sample-2.png') }}"
                                            alt="image-sample" class="img-fluid rounded">
                                    </div>
                                    <div class="col-lg-3 col-6">
                                        <img src="{{ asset('assets/images/reports/image-sample-3.png') }}"
                                            alt="image-sample" class="img-fluid rounded">
                                    </div>
                                    <div class="col-lg-3 col-6">
                                        <img src="{{ asset('assets/images/reports/image-sample-4.png') }}"
                                            alt="image-sample" class="img-fluid rounded">
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="emergency-report-modal" tabindex="-1" aria-labelledby="emergency-report-modal"
        aria-hidden="true">
        <div class="modal-dialog rounded modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <div class="form-group mb-5">
                                <label class="h5">
                                    <svg class="me-2" width="20" height="20" viewBox="0 0 20 20"
                                        ...
                                        <rect x="0.25" y="0.25" width="19.5" height="19.5"
                                            rx="9.75" fill="white" />
                                        <path
                                            d="M3 10C3 9.72386 3.22386 9.5 3.5 9.5H5C5.27614 9.5 5.5 9.72386 5.5 10C5.5 10.2761 5.27614 10.5 5 10.5H3.5C3.22386 10.5 3 10.2761 3 10Z"
                                            fill="#244A8D" />
                                        <path
                                            d="M14.5 10C14.5 9.72386 14.7239 9.5 15 9.5H16.5C16.7761 9.5 17 9.72386 17 10C17 10.2761 16.7761 10.5 16.5 10.5H15C14.7239 10.5 14.5 10.2761 14.5 10Z"
                                            fill="#244A8D" />
                                        <path
                                            d="M13.5 10C13.5 11.933 11.933 13.5 10 13.5C8.067 13.5 6.5 11.933 6.5 10C6.5 8.067 8.067 6.5 10 6.5C11.933 6.5 13.5 8.067 13.5 10ZM7.55 10C7.55 11.3531 8.6469 12.45 10 12.45C11.3531 12.45 12.45 11.3531 12.45 10C12.45 8.6469 11.3531 7.55 10 7.55C8.6469 7.55 7.55 8.6469 7.55 10Z"
                                            fill="#244A8D" />
                                        <path
                                            ...
                                            fill="#244A8D" />
                                        <path
                                            d="M10 5.5C9.72386 5.5 9.5 5.27614 9.5 5V3.5C9.5 3.22386 9.72386 3 10 3C10.2761 3 10.5 3.22386 10.5 3.5V5C10.5 5.27614 10.2761 5.5 10 5.5Z"
                                            fill="#244A8D" />
                                        <path
                                            d="M10 17C9.72386 17 9.5 16.7761 9.5 16.5V15C9.5 14.7239 9.72386 14.5 10 14.5C10.2761 14.5 10.5 14.7239 10.5 15V16.5C10.5 16.7761 10.2761 17 10 17Z"
                                            fill="#244A8D" />
                                        <rect x="0.25" y="0.25" width="19.5" height="19.5"
                                            rx="9.75" stroke="#244A8D" stroke-width="0.5" />
                                    </svg>
                                    Location
                                </label>
                                <img src="{{ asset('assets/images/reports/map.png') }}" alt="map"
                                    class="img-fluid">
                            </div>
                            <div class="form-group mb-5">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <p class="fs-4 fw-bold">All the Data Will be lost. Do you want to <br> delete this report?</p>
                </div>
