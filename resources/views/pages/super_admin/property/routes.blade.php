<x-default-layout>
    ...
    <section class="property-section">
        ...
        <div class="py-3">
            <ul class="breadcrumb">
                <li><a href="{{route("superadmin.properties.index")}}">All New Properties</a></li>
                <li><i class="fas fa-chevron-right"></i></li>
                <li><a href="{{route("superadmin.properties.create")}}">Create new property</a></li>
                <li><i class="fas fa-chevron-right"></i></li>
                <li><a href="{{route('superadmin.properties.shift')}}">Create shifts</a></li>
                <li><i class="fas fa-chevron-right"></i></li>
                <li><a href="{{route("superadmin.properties.morningShift")}}">Create Checkpoints & Tasks</a></li>
                <li><i class="fas fa-chevron-right"></i></li>
                <li class="active"><a href="{{route("superadmin.properties.routes")}}">Routes</a></li>
            </ul>
        </div>
        {{-- Breadcrumbs (End) --}}
        ...
        <div class="">
                ...
                <div class="card-body p-5">
                    <div class="row mb-10">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 text-lg-end">
                           <a href="{{route("superadmin.properties.create")}}"><button class="d-inline-block btn btn-primary inverse text-uppercase"><svg width="19" class="me-2" height="19" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="card property-create-card mb-6">
                <div class="card-body p-5 text-end">
                  <a href="{{route("superadmin.properties.index")}}"  class="btn btn-primary inverse me-3">Save & Exit</a>
                    <a href="{{route("superadmin.properties.assignGuards")}}" class="btn btn-primary">Save & Next</a>
                </div>
            </div>
    ...
    <script>
        const handleRemoveRoute = (event) => {
            event.target.closest('.route-input-row').remove();
        }
        ...
        const handleAddRoute = () => {
            let html = `<div class="d-flex flex-column">
                ...
                <div>
                    <button onclick="handleRemoveRoute(event)"><i class="fas fa-trash"></i></button>
                </div>`;
