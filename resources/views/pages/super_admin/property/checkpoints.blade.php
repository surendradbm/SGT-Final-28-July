    ...
    <section class="property-section">
        ...
        <div class="py-3">
            <ul class="breadcrumb">
                ...
                <li><a href="{{route("superadmin.properties.create")}}">Rivi properties</a></li>
                <li><i class="fas fa-chevron-right"></i></li>
                <li><a href="{{route("superadmin.properties.shift")}}">Property Shifts</a></li>
                <li><i class="fas fa-chevron-right"></i></li>
                <li class="active"><a href="{{route("superadmin.properties.checkpoints")}}">Property Checkpoints</a></li>
            </ul>
        </div>
        {{-- Breadcrumbs (End) --}}
        ...
        <div class="card property-create-card no-checkpoints mb-6">
            <div class="card-body p-5 py-20 d-flex flex-column align-items-center justify-content-center text-center">
                ...
                <a href="{{route("superadmin.properties.morningShift")}}">+ CREATE CHECKPOINTS</a>
            </div>
        </div>
        ...
        <div class="card property-create-card checkpoints-list mb-6">
            <div class="card-body p-5">
                <div class="d-flex flex-lg-row flex-column justify-content-between">
                    ...
                    <div class="mb-4">
                        <a href="{{route("superadmin.properties.morningShift")}}" class="btn btn-primary">Add more checkpoint</a>
                    </div>
                </div>
                <div class="row mb-5">
                ...
                <div class="text-end">
                <a href="{{route("superadmin.properties.index")}}" class="btn btn-primary inverse me-3">Save & Exit</button> </a>
            <a href="{{route("superadmin.properties.routes")}}" class="btn btn-primary">Save & Next</a>
                </div>
            </div>
        </div>
        {{-- Section Content (End) --}}
