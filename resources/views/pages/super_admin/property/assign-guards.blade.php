    ...
    <section class="property-section">
        ...
        <div class="py-3">
            <ul class="breadcrumb">
                ...
                <li><i class="fas fa-chevron-right"></i></li>
                <li><a href="{{route("superadmin.properties.checkpoints")}}">Create Checkpoints & Tasks</a></li>
                <li><i class="fas fa-chevron-right"></i></li>
                <li><a href="{{route("superadmin.properties.routes")}}">Routes</a></li>
                <li><i class="fas fa-chevron-right"></i></li>
                <li class="active"><a href="{{route("superadmin.properties.assignGuards")}}">Assign Guards</a></li>
            </ul>
        </div>
        {{-- Breadcrumbs (End) --}}
        ...
        <div class="">
            ...
            <div class="card property-create-card mb-6">
                ...
                <a href="{{route("superadmin.properties.index")}}" class="btn btn-primary inverse me-3">Save & Exit</button> </a>
                    <a href="{{route("superadmin.properties.index")}}" class="btn btn-primary">Finish</a>
                </div>
            </div>
