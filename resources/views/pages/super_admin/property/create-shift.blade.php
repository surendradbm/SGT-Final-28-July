    ...
    <section class="property-section">
        ...
        <div class="py-3">
            <ul class="breadcrumb">
                ...
                <li><i class="fas fa-chevron-right"></i></li>
                <li class="active"><a href="{{route("superadmin.properties.shift")}}">Property Shifts</a></li>
            </ul>
        </div>
        {{-- Breadcrumbs (End) --}}
        ...
        <div class="card property-create-card mb-6">
            <div class="card-body p-5">
                ...
                <div class="text-end">
                    ...
                    <a href="{{route("superadmin.properties.checkpoints")}}" class="btn btn-primary">Save & Next</a>
                </div>
            </div>
        </div>
        {{-- Section Content (End) --}}
