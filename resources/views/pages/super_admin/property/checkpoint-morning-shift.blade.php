<x-default-layout>
    ...
    <section class="property-section">
        ...
        <div class="py-3">
            <ul class="breadcrumb">
                ...
                <li><i class="fas fa-chevron-right"></i></li>
                <li class="active"><a href="{{ route('superadmin.properties.morningShift') }}">Create Checkpoints &
                        Tasks</a>
                </li>
            </ul>
        </div>
        ...
        <div class="">
            ...
            <div class="card property-create-card mb-6">
                <div class="card-body p-5 text-end">
                    <a href="{{ route('superadmin.properties.index') }}" class="btn btn-primary inverse me-3">Save &
                        Exit</button> </a>
    ...
    <script>
        const handleAddTask = (event) => {
            ...
            let html = `<div class="task row align-items-center justify-content-between border-bottom py-3">
                <div class="col-lg-6 task-input-row">
                    <div>
                        <label class="mb-lg-0 mb-2">Task ${inputLength + 1}</label>
                        <input type="text" class="form-control" required>
                    </div>
                </div>
                <div class="col-lg-1 task-input-row">
                    <div class="text-end">
