        ...
        <div class="card-body">
            <div class="row mb-3">
                ...
                <div class="col-lg-6 col-md-4 col-12 text-end">
                    <a href="{{route('superadmin.customer.all')}}" class="btn btn-primary">Back to  Customer</a>
                </div>
                <div class="col-lg-6 col-md-6 col-12 text-end">
                    {{-- Breadcrumbs (Start) --}}
                    <ul class="breadcrumb">
                        <li><a href="{{route("superadmin.customer.all")}}">Customer</a></li>
                        <li><i class="fas fa-chevron-right"></i></li>
                        <li class="active"><a href="{{route("superadmin.customer.edit")}}">Edit Customer</a></li>
                    </ul>
                    {{-- Breadcrumbs (End) --}}
                </div>
            </div>
                ...
                <div class="row mb-5">
                    <div class="col-md-12">
                        ...
                        <div class="image-input image-input-empty" data-kt-image-input="true">
                            ...
                            <!--begin::Edit button-->
                            <label class="btn btn-primary btn-sm" data-kt-image-input-action="change" data-bs-dismiss="click"> {{ __('customer.Edit_Photo') }}
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-12">
                       <button type="submit" class="btn btn-primary mt-17">Reset Password</button>
                    </div>
                </div>
