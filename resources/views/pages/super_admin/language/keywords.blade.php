...
<div class="card card-flush shadow-sm mt-5">
    <div class="card-body py-5">
        <form action="">
            <div class="row mt-5">
                <div class="col-lg-6 col-md-4 col-12">
                    <h4 class="text-dark">Translated Keywords</h4>
                        ...
                        <tr class="bg-primary text-white">
                            <th width="10%">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label text-white" for="headCheckbox">Select All
                                    </label>
                                </div>
                            </th>
                            <th width="8%">S.No.</th>
                            <th width="40%">English</th>
                            <th width="40%">Spanish</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td>1</td>
                            <td>
                                <span class="text-gray-700 fw-bold">Manage your Team from anywhere make corrections and provide information in real time</span>
                            </td>
                            <td>
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter Keywords...">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>2</td>
                            <td>
                                <span class="text-gray-700 fw-bold">With a built in scheduler, group chat and active task system your team will have the tools required for success</span>
                            </td>
                            <td>
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter Keywords...">
                            </td>
