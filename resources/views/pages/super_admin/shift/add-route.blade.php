    ...
    <section class="property-section">
        ...
        <div class="py-3">
            <ul class="breadcrumb">
                ...
                <li><i class="fas fa-chevron-right"></i></li>
                <li class="active"><a href="{{route('superadmin.shift.add_route')}}">Add Routes</a></li>
            </ul>
        </div>
        {{-- Breadcrumbs (End) --}}
        {{-- Top Header (Start) --}}
        ...
        <div class="card property-create-card mb-6">
            <div class="card-body p-5 text-end">
                <button type="button" onclick="$('#next-button').html('Save')" class="btn btn-primary inverse me-3">Save &
                    Exit</button>
                <a href="{{ route('superadmin.shift.assign_guard') }}" id="next-button" class="btn btn-primary">Save & Next</a>
            </div>
        </div>
        {{-- Section Content (End) --}}
