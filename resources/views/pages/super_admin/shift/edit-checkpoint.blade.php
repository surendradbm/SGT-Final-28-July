    ...
    <section class="property-section">
        ...
        <div class="py-3">
            <ul class="breadcrumb">
                ...
                <li><i class="fas fa-chevron-right"></i></li>
                <li class="active"><a href="{{route('superadmin.shift.edit_checkpoint')}}">Edit Checkpoints & Tasks</a></li>
            </ul>
        </div>
        {{-- Breadcrumbs (End) --}}
            ...
            <div class="card-body p-5">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12 mb-5">
                        <div class="mb-lg-5">
                            <h2 class="text-dark mb-3 title">Checkpoint 1</h2>
                        </div>
                    </div>
            ...
            <div class="card-body p-5">
                <div class="row">
                    <div class="col-lg-12 col-12 mb-3">
                        <div class="mb-lg-5">
                            <h2 class="text-dark mb-3 title">Latitude & Longitude*</h2>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12 mb-5">
                        <div class="form-group">
        ...
        <div class="card property-create-card checkpoints-task mb-6">
            <div class="card-body p-5">
                <div class="row">
                    <div class="col-lg-12 col-12 mb-5">
                        <div class="mb-lg-5">
                            <h2 class="text-dark mb-3 title">Tasks for this checkpoint</h2>
                        </div>
                    </div>
                </div>
                <div>
        ...
        <div class="card property-create-card mb-6">
            <div class="card-body p-5 text-end">
                <button type="button" onclick="$('#next-button').html('Save')" class="btn btn-primary inverse me-3">Save &
                    Exit</button>
                <a href="{{ route('superadmin.shift.add_route') }}" id="next-button" class="btn btn-primary">Save & Next</a>
            </div>
        </div>
        {{-- Section Content (End) --}}
