<x-default-layout>
    ...
    <div class="py-3">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="{{ route('superadmin.shift.add_shift') }}">Add Shifts</a></li>
        </ul>
    </div>
    {{-- Breadcrumbs (End) --}}
        ...
        <div class="card property-create-card mb-6">
            <div class="card-body p-5 text-end">
                <button type="button" onclick="$('#next-button').html('Save')" class="btn btn-primary inverse me-3">Save &
                    Exit</button>
                <a href="{{ route('superadmin.shift.add_checkpoint') }}" id="next-button" class="btn btn-primary">Save & Next</a>
            </div>
        </div>
        {{-- Section Content (End) --}}
