<x-auth-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <input type="hidden" name="token" value="{{ $request->input('token') }}" required>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="password" class="block mt-1 w-full" type="password" name="password" required required/>
