<x-auth-layout>
    <form action="{{ route('property-owner.dashboard') }}" method="get">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 col-md-7 col-12">
                <div class="auth-form text-center">
                    ...
                    <h1 class="title mb-7">Nice to have you, {{ auth()->user()->first_name }} 🙌</h1>
                    <p class="text-dark mb-12">A link was just sent to your email and phone to download the application.
                    </p>

                    <div class="d-flex align-items-center justify-content-center mb-10">
                        <div>
                            <button class="btn btn-primary">Go To Dashboard <i
