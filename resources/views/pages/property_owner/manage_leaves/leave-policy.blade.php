<x-default-layout>
        ...
        <div class="card-body py-3">
            <div class="row mb-3">
                <div class="col-lg-6 col-md-4 col-12">
                    <div class="title">Leave Policies</div>
                </div>
                <div class="col-lg-6 col-md-4 col-12 text-end">
                    <a href="javascript:void(0);" class="btn btn-primary btn-sm inverse icon-style" data-bs-toggle="modal"
                    data-bs-target="#AddPolicy">+ Add Leave Policy</a>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px p-3"
                                    ...
                                    <div class="menu-item">
                                        <a href="javascript:void(0)" class="menu-link" data-bs-toggle="modal"
                                            data-bs-target="#ViewPolicy">View Policy</a>
                                    </div>
                                    <div class="menu-item">
                                        <a href="javascript:void(0)" class="menu-link" data-bs-toggle="modal"
                                            data-bs-target="#DeleteModal1">Delete Policy</a>
                                    </div>
    ...
    {{-- AddPolicy Modal Model --}}
    <div class="modal fade" id="AddPolicy" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">
                        <span class="me-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="#244B8A">
                        ...
                        <span>Add New Leave Policy</span>
                    </h3>
                ...
                <div class="modal-body">
                    <div class="row ">
                        <div class="col-lg-12 col-md-12 col-12 mb-5">
                            <label class="required form-label">Policy</label>
    ...
    {{-- ViewPolicy Modal Model --}}
    <div class="modal fade" id="ViewPolicy" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">
                ...
                <div class="modal-body">
                    <div class="row ">
                        <div class="col-lg-12 col-md-12 col-12 mb-5">
                            <label class="required form-label">Policy</label>
                            <textarea class="form-control form-control-solid" maxlength="150" rows="4">Porem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis. Class aptent taciti socio.</textarea>
                            <span class="fs-6 fw-semibold text-gray-700 float-end">0/150 Characters</span>
                        </div>
                    </div>
                </div>
