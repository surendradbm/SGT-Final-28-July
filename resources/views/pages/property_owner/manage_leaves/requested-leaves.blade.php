<x-default-layout>
        ...
        <div class="card-body py-3">
            <div class="row mb-3">
                <div class="col-lg-6 col-md-4 col-12">
                    <div class="title">Requested Leaves</div>
                </div>
                ...
                <table class="table table-hover table-rounded border gy-5 gs-7" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-outline badge-primary">Pending </span></td>
                            <td>
                                <button
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px p-3"
                                    ...
                                    <div class="menu-item">
                                        <a href="javascript:void(0)" class="menu-link" data-bs-toggle="modal"
                                            data-bs-target="#AssignGuardModal">Assign Another Guard</a>
                                    </div>
                                    <div class="menu-item">
                                        <a href="javascript:void(0)" class="menu-link" data-bs-toggle="modal"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">
                        ...
                        <span class="badge badge-outline badge-primary">Pending </span>
                    </h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                        onclick="Rejectfun('0')">Reject</button>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">
                        ...
                        <span>Leave Rejection Reason</span>
                    </h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row ">
                        <div class="col-lg-12 col-md-12 col-12 mb-5">
                            ...
                            <textarea class="form-control form-control-solid" maxlength="150" rows="4"></textarea>
    ...
    {{-- Assign Guard Modal Model --}}
    <div class="modal fade" id="AssignGuardModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">
                        <span class="me-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                viewBox="0 0 30 30" fill="none">
                                <path
                                    d="M22.7778 6.2H18.1333C17.6667 4.924 16.4444 4 15 4C13.5556 4 12.3333 4.924 11.8667 6.2H7.22222C6 6.2 5 7.19 5 8.4V23.8C5 25.01 6 26 7.22222 26H22.7778C24 26 25 25.01 25 23.8V8.4C25 7.19 24 6.2 22.7778 6.2ZM15 6.2C15.6111 6.2 16.1111 6.695 16.1111 7.3C16.1111 7.905 15.6111 8.4 15 8.4C14.3889 8.4 13.8889 7.905 13.8889 7.3C13.8889 6.695 14.3889 6.2 15 6.2ZM15 10.6C16.8444 10.6 18.3333 12.074 18.3333 13.9C18.3333 15.726 16.8444 17.2 15 17.2C13.1556 17.2 11.6667 15.726 11.6667 13.9C11.6667 12.074 13.1556 10.6 15 10.6ZM21.6667 23.8H8.33333V22.26C8.33333 20.06 12.7778 18.85 15 18.85C17.2222 18.85 21.6667 20.06 21.6667 22.26V23.8Z"
                                    fill="#244B8A" />
                            </svg>
                        </span>
                        <span>Assign To Another Guard</span>
                    </h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="#">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-12 mb-5">
                                <label class="form-label required">Shift 1 </label>
                                <input type="text" class="form-control form-control-solid"
                                    value="Hallway-Morning" />
                            </div>
                            <div class="col-lg-12 col-md-12 col-12 mb-5">
                                <label class="form-label required">Available Guard</label>
                                <select class="form-select form-select-solid">
                                    <option value="1">Rakesh Kumar</option>
                            ...
                            <div class="col-lg-12 col-md-12 col-12 mb-5">
                                <label class="form-check form-check-sm form-check-custom form-check-solid me-5">
                                    ...
                                    <span class="form-check-label text-gray-900 fw-semibold">Assign on every
                                        shift</span>
                                </label>
                            </div>
                            <div class="col-lg-12 col-md-12 col-12 mb-5">
                                <label class="form-label required">Shift 2 </label>
                                <input type="text" class="form-control form-control-solid"
                                    value="Parking-Night "/>
                            </div>
                            <div class="col-lg-12 col-md-12 col-12 mb-5">
