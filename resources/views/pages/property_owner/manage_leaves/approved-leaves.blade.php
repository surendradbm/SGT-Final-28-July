<x-default-layout>
                ...
                <table class="table table-hover table-rounded border gy-5 gs-7" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-outline badge-success">Approved</span></td>
                            <td>
                                <button
    ...
    {{-- Request Modal Model --}}
    <div class="modal fade" id="RequestModal" tabindex="-1" style="background-image: url()" >
                ...
                <div class="modal-body">
                    <div class="row ">
                        ...
                        <div class="col-lg-12 col-md-12 col-12 mb-5">
                            ...
                            <textarea class="form-control form-control-solid" readonly>Korem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis.</textarea>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <h4 class="text-dark fw-bold mb-5">Proxy Details</h4>
                        <div class="col-lg-12 col-md-12 col-12 mb-5">
                            <label class="form-label required">Shift 1 Assigned To</label>
                            <input type="text" class="form-control form-control-solid" value="Rakesh Kumar"
                                readonly />
                        </div>
                        <div class="col-lg-12 col-md-12 col-12 mb-5">
                            <label class="form-label required">Shift 2 Assigned To</label>
                            <input type="text" class="form-control form-control-solid" value="Mohit Kumar"
                                readonly />
                        </div>
                    </div>
                </div>
