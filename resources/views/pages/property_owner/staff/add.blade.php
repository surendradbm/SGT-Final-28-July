<x-default-layout>
    ...
    <div class="py-3">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="{{ route('property_owner.staff.add') }}">Add New Staff</a></li>
        </ul>
    </div>
    {{-- Breadcrumbs (End) --}}
        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-lg-6 col-md-4 col-12">
                    <div class="title">Add New Staff</div>
                </div>
                    ...
                    <div class="col-lg-12 col-md-4 col-12">
                        ...
                        <div class="float-end">
                            <div class="form-check form-switch">
                                <input class="form-check-input body-toggle" name="status" id="status" type="checkbox" role="switch"
                                    id="flexSwitchCheckDefault" onchange="toggleSwitch()" checked>
                                <b><label for="status" class="form-check-label text-dark" for="flexSwitchCheckDefault">Active Status</label></b>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-lg-6 col-md-4 col-12 mb-5">
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Pick a date" id="date"/>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-4 col-12 mb-5">
                        <div class="form-group">
