        ...
        <div class="card-body">
            <div class="row mb-3">
                ...
                <div class="col-lg-6 col-md-4 col-12 text-end">
                    <a href="{{ route('property_owner.staff.add') }}" class="btn btn-primary inverse">+ Add New Staff</a>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="card-body p-4">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                    ...
                                    <path
                                        d="M15 17.4C18.3085 17.4 20.9905 14.1765 20.9905 10.2C20.9905 6.22355 18.3085 3 15 3C11.6916 3 9.00952 6.22355 9.00952 10.2C9.00952 14.1765 11.6916 17.4 15 17.4Z"
                                        fill="#244B8A" />
                                    <path
                                        d="M26.7414 23.52C25.6631 21.36 23.6263 19.56 20.9905 18.48C20.2716 18.24 19.433 18.24 18.8339 18.6C17.6358 19.32 16.4377 19.68 15 19.68C13.5623 19.68 12.3642 19.32 11.1661 18.6C10.567 18.36 9.72835 18.24 9.00949 18.6C6.37367 19.68 4.33689 21.48 3.2586 23.64C2.41993 25.2 3.73784 27 5.53499 27H24.465C26.2622 27 27.5801 25.2 26.7414 23.52Z"
                                        fill="#244B8A" />
                                </svg>
                                <label>Total <br>
                                    Staff</label>
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-end">
                                ...
                                {{-- Export button Start --}}
                                <button id="aman" type="button" class="btn btn-theame"
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 fw-semibold w-200px p-3"
                                    ...
                                    <div class="menu-item"><a href="#" class="menu-link"
                                            data-kt-export="csv">Export as CSV</a></div>
                                    <div class="menu-item"><a href="#" class="menu-link"
                                            data-kt-export="pdf">Export as PDF</a></div>
                                </div>
                                {{-- Export button End --}}
                            </div>
                        </div>
                            ...
                            <table class="table table-hover display responsive table-rounded border gy-5 gs-7"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <th>1</th>
                                        <td><a href="{{ route('property_owner.staff.edit') }}">Aman Singh</a></td>
                                        <td>Admin-IND</td>
                                        ...
                                        <td>
                                            <a href="{{ route('property_owner.staff.edit') }}"
