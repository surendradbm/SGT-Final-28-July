        ...
        <div class="card-body">
            <div class="row mb-3">
                ...
                <div class="col-lg-6 col-md-4 col-12 text-end">
                    <a href="{{route('property_owner.staff.all')}}" class="btn btn-primary">Back to  Staff</a>
                </div>
                <div class="col-lg-6 col-md-6 col-12 text-end">
                    {{-- Breadcrumbs (Start) --}}
                    <ul class="breadcrumb">
                        <li><a href="{{route("property_owner.staff.all")}}">All Staff</a></li>
                        <li><i class="fas fa-chevron-right"></i></li>
                        <li class="active"><a href="{{route("property_owner.staff.edit")}}">Astana Singh</a></li>
                    </ul>
                    {{-- Breadcrumbs (End) --}}
                </div>
            </div>
            ...
            <div class="card-body py-5">
                <div class="row mb-5">
                    <div class="col-lg-12 col-md-4 col-12">
                        <h4 class="text-dark fw-bold">Below are the details to Astana Singh</h4>
                        <div class="float-end">
                ...
                <div class="row mb-5">
                    <div class="col-lg-6 col-md-4 col-12 mb-5">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid" name="name" id="name"
                                placeholder="Enter Name" value="Astana Singh" required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-4 col-12 mb-5">
                        <div class="form-group">
                            ...
                            <select class="form-select form-select-solid" id="messenger" name="messenger"
                                ...
                                <option selected value="">Role 1</option>
                    ...
                    <div class="col-lg-6 col-md-4 col-12 mb-5">
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Pick a date" value="16-06-2002" id="date"/>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-4 col-12 mb-5">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control form-control-solid" name="maximum_guards"
                                ...
                                placeholder="Enter email address" value="astana@gmail.com" required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-4 col-12 mb-5">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-solid"
                                ...
                                placeholder="Enter mobile number" value="9999999999" required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-4 col-12 mb-5">
                        <div class="form-group">
                            <b><label class="required form-label" for="title">Confirm Password</label><br></b>
                            <div class="password-input">
                                <input type="password" class="form-control form-control-solid" id="password" name="password"
