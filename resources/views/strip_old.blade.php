                            ...
                            <form role="form" action="{{ route('stripe.post') }}" method="post"
                                ...
                                <div class='form-group mb-6'>
                                    <div class='col-xs-12 form-group'>
                                        <label class='control-label mb-2 form-label'><b>Name On
                                                Card</b><em>*</em></label>
                                        <input class='form-control mb-2' size='4' type='text'
                                            name="Customer_name" value="Aman Prasad">
                                    </div>
                                </div>
                                <div class='form-group mb-6>
                                <div class='col-xs-12
                                    form-group'>
                                    <label class='control-label mb-2 form-label'><b>Card Number</b><em>*</em></label>
                                    <input autocomplete='off' class='form-control mb-2 card-number' size='20'
                                        type='text' name="card_number" value="4242 4242 4242 4242">
                                </div>
                        </div>
                        <div class='form-row row'>
                            <div class='col-xs-12 col-md-4 form-group cvc'>
                                <label class='control-label mb-2 form-label'><b>CVV</b><em>*</em></label>
                                <input autocomplete='off' class='form-control mb-2 card-cvc' placeholder='ex. 311'
                                    size='4' type='text' name="cvv" value="311">
                            </div>
                        </div>
                        <div class='form-row row'>
                            <div class='col-xs-12 col-md-4 form-group expiration'>
                                <label class='control-label mb-2 form-label'><b>Expiration Month</b><em>*</em></label>
                                <input class='form-control mb-2 card-expiry-month' placeholder='MM' size='2'
                                    type='text' name="exp_month" value="12">
                            </div>
                            <div class='col-xs-12 col-md-4 form-group expiration'>
                                <label class='control-label mb-2 form-label'><b>Expiration Year</b><em>*</em></label>
                                <input class='form-control mb-2 card-expiry-year' placeholder='YYYY' size='4'
                                    type='text' name="exp_year" value="2028">
                            </div>
                        </div>
                        {{-- <input autocomplete='off' class='form-control card-number' size='20' type='text'
                            name="payment_amount" value="{{ $price }}" hidden> --}}
                        {{-- <div class='form-row row'>
