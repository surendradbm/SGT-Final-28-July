...
<div class="app-navbar flex-shrink-0">
    ...
    {{-- Lang Manager --}}
    <div class="flex-shrink-0 dropdown" id="dropdown_lang">
    ...
    <div class="app-navbar-item ms-5 ms-md-5" id="kt_header_user_menu_toggle">
        ...
        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
            ...
            <h6 class="name">{{ auth()->user()->first_name }} {{ auth()->user()->last_name }}</h6>
            <i class="fas fa-chevron-down"></i>
        </div>

        <?php if ($guard === "superadmin"){  ?>
            @include('partials/menus/_superadmin_user-account-menu')
            <?php } ?>
        <!--end::Menu wrapper-->
    </div>
    <!--end::User menu-->
