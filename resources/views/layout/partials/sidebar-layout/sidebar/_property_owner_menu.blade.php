...
<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
    ...
    <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true"
        ...
        <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true"
                ...
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                        <a class="menu-link {{ $menu . '/' . $subMenu == 'staff/all' ? 'active' : '' }}"
                            href="{{ route('property_owner.staff.all') }}">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ $menu . '/' . $subMenu == 'staff/add' ? 'active' : '' }}"
                            href="{{ route('property_owner.staff.add') }}">
                            <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
            ...
            <!--begin: MessagesMenu item-->
            <div class="menu-item">
                <a class="menu-link {{ $menu . '/' . $subMenu == 'messages/' ? 'active' : '' }}"
                    href="{{ route('property_owner.messages') }}">
                    <span class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <!--begin:Time Sheet Menu -->
            <div class="menu-item">
                <a class="menu-link {{ $menu . '/' . $subMenu == 'timesheet/' ? 'active' : '' }}"
                    href="{{ route('property_owner.timesheet') }}">
                    <span class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <span class="menu-link">
                    <span class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M21 22H3V18.364H21V22ZM13.0534 4.90194L16.4621 8.31065L8.22668 16.5461H4.81798V13.1374L13.0534 4.90194ZM17.4347 7.33803L14.026 3.92933L15.6895 2.26588C16.044 1.91137 16.6166 1.91137 16.9711 2.26588L19.0982 4.39291C19.4527 4.74742 19.4527 5.32008 19.0982 5.67458L17.4347 7.33803Z" />
                        </svg>
                    </span>
